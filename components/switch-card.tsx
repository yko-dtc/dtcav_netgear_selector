      ...
      <article className={`overflow-hidden rounded-[28px] border backdrop-blur-xl ${cardAccent}`}>
        ...
        >
          <div className="flex items-start gap-4">
            <div className="relative h-[72px] w-[88px] shrink-0 overflow-hidden rounded-2xl border border-slate-800 bg-[linear-gradient(135deg,#0f172a,#172554)] sm:h-20 sm:w-24">
              {imageFailed ? (
                <div className="flex h-full items-center justify-center px-2 text-center text-[11px] font-medium leading-4 text-slate-400">
                  Image coming soon
                </div>
              ) : (
                <Image
      ...
      {isOpen ? (
        ...
        >
          <div
            ...
            className="max-h-[90vh] w-full max-w-4xl overflow-y-auto rounded-[32px] border border-slate-800 bg-slate-950 shadow-[0_40px_120px_rgba(2,6,23,0.75)]"
          ...
          >
            ...
            <div className="grid gap-6 px-5 py-5 xl:grid-cols-[280px_minmax(0,1fr)] xl:px-6 xl:py-6">
              <div className="space-y-4">
                <div className="relative h-56 overflow-hidden rounded-[28px] border border-slate-800 bg-[linear-gradient(135deg,#0f172a,#172554)]">
                  {modalImageFailed ? (
                ...
                <div className="grid gap-3">
                  ...
                  <button
                    ...
                    className="rounded-full border border-slate-700 bg-slate-900 px-4 py-3 text-sm font-medium text-slate-200 transition hover:border-slate-500 hover:bg-slate-800 hover:text-white"
                  >
